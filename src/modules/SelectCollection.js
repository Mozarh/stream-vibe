...
import MatchMedia from "@/constans/MatchMedia"
...
class Select extends BaseComponent {
  ...
  constructor(rootElement) {
    ...
    this.orginalControlElement = this.rootElement.querySelector(
    ...
    this.state = this.getProxyState({
      ...this.initialState,
      currentOptionIndex: this.orginalControlElement.selectedIndex,
      selectedOptionElement:
        this.optionElements[this.orginalControlElement.selectedIndex],
    })
  ...
  updateUI() {
    ...
    const updateOriginalControl = () => {
      this.orginalControlElement.value = newSelectedOptionValue
    }
  ...
  updateTabIndexes(isMobileDevice = MatchMedia.mobile.matches) {
    this.orginalControlElement.tabIndex = isMobileDevice ? 0 : -1
  ...
  bindEvents() {
    ...
    this.orginalControlElement.addEventListener(
      "change",
